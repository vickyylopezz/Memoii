...
describe 'Luchador' do
  ...
  it '01-Puntaje de humano-con-espada en estadio es 2' do
    expect(Luchador.new(humano, espada, Estadio.new).puntaje).to eq 2
  end

  it '02-Puntaje de humano-con-mano en estadio es 1' do
    expect(Luchador.new(humano, mano, Estadio.new).puntaje).to eq 1
  end

  it '03-Puntaje de lobo-con-mano en estadio es 3' do
    expect(Luchador.new(lobo, mano, Estadio.new).puntaje).to eq 3
  end

  it '04-Puntaje de lobo-con-espada en estadio es 6' do
    expect(Luchador.new(lobo, espada, Estadio.new).puntaje).to eq 6
  end
